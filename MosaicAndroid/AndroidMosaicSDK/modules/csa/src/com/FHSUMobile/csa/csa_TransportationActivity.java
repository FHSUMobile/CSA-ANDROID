...
public class csa_TransportationActivity extends Activity implements AdapterView.OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(Mosaic.getResId(this, Mosaic.LAYOUT_RESOURCE, "csa_activity_transportation"));
		
		Menu = (ListView) findViewById(Mosaic.getResId(this, Mosaic.ID_RESOURCE, "csa_TransportationListView")); //connects our Menu object to our listview
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(Mosaic.getResId(this, Mosaic.MENU_RESOURCE, "csa_transportation"), menu);
		return true;
	}
