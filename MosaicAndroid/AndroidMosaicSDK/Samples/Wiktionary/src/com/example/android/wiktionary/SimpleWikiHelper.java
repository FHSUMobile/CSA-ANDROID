...
public class SimpleWikiHelper {
    ...
    public static void prepareUserAgent(Context context) {
        try {
            ...
            int userAgentId = Mosaic.getResId( context, Mosaic.STRING_RESOURCE, "wiktionary_template_user_agent" );
            sUserAgent = String.format(context.getString(userAgentId), info.packageName, info.versionName);
